...
Drücken Sie in Visual Studio **F5** erstellen und Ausführen der app. Nachdem die Web-app gestartet wird, wählen Sie **Accept** akzeptieren die Verwendung von Cookies (ggf.), und wählen Sie dann **Anmeldung**.
