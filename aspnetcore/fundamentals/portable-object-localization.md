...
**Hinweis**: Orchard Core ist ein Microsoft-Produkt nicht. Microsoft bietet daher keinen Support für dieses Feature an.
...
- `#:`: Ein Kommentar, der angibt, des Kontexts der Zeichenfolge, die übersetzt werden. Die gleiche Zeichenfolge wird möglicherweise anders übersetzt, je nachdem, wo sie verwendet wird.
...
- `msgid_plural`: Die übersetzte Zeichenfolge im plural.
...
**Hinweis**: In einem realen Szenario würde eine Variable verwendet werden, die Anzahl darstellen. Hier wiederholen wir den gleichen Code mit drei verschiedenen Werten, um einen sehr speziellen Fall verfügbar zu machen.
