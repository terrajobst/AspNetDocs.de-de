...
* Entfernen Sie das Attribut "Version" auf den Paketverweis `Microsoft.AspNetCore.App`. Welche Projekte `<Project Sdk="Microsoft.NET.Sdk.Web">` müssen sich nicht um die Version festzulegen. Die Version impliziert durch die das Zielframework und ausgewählt, um die Methode am besten zu entsprechen, die ASP.NET Core 2.1 funktioniert. (Siehe unten für Weitere Informationen.)
...
Bekannte Probleme für Projekte, die auf gemeinsam genutzten Frameworks:
