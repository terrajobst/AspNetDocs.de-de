...
- [Empfehlungen](overview/index.md)
    ...
    - [Leitfaden für die API](overview/guide-to-the-api/index.md)
        ...
        - [Leitfaden für die Hubs-API – JavaScript-Client](overview/guide-to-the-api/hubs-api-guide-javascript-client.md)
        - [Leitfaden für die Hubs-API – .NET-Client (C#)](overview/guide-to-the-api/hubs-api-guide-net-client.md)
        - [Überblick und Behandeln von Ereignissen im Zusammenhang mit der Verbindungslebensdauer in SignalR](overview/guide-to-the-api/handling-connection-lifetime-events.md)
        - [Arbeiten mit Gruppen in SignalR](overview/guide-to-the-api/working-with-groups.md)
    ...
    - [Leistung](overview/performance/index.md)
        ...
        - [Verwenden von SignalR-Leistungsindikatoren in einer Azure-Webrolle](overview/performance/using-signalr-performance-counters-in-an-azure-web-role.md)
    - [Bereitstellung und Hosting](overview/deployment/index.md)

        - [Tutorial: Selfhosten von SignalR](overview/deployment/tutorial-signalr-self-host.md)
        - [Verwenden von SignalR mit Web-Apps in Azure App Service](overview/deployment/using-signalr-with-azure-web-sites.md)
    ...
    - [Ältere Versionen](overview/older-versions/index.md)
        ...
        - [Tutorial: Erste Schritte mit SignalR 1.x](overview/older-versions/tutorial-getting-started-with-signalr.md)
        - [Tutorial: Erste Schritte mit SignalR 1.x und MVC 4](overview/older-versions/tutorial-getting-started-with-signalr-and-mvc-4.md)
        - [Häufiges Senden von Echtzeitnachrichten mit SignalR 1.x](overview/older-versions/tutorial-high-frequency-realtime-with-signalr.md)
        - [Tutorial: Serverübertragung mit ASP.NET SignalR 1.x](overview/older-versions/tutorial-server-broadcast-with-aspnet-signalr.md)
        - [Leitfaden für die Hubs-API – Server](overview/older-versions/signalr-1x-hubs-api-guide-server.md)
        - [Leitfaden für die SignalR 1.x-Hubs-API – JavaScript-Client](overview/older-versions/signalr-1x-hubs-api-guide-javascript-client.md)
        - [Leitfaden für die Hubs-API – .NET-Client](overview/older-versions/signalr-1x-hubs-api-guide-net-client.md)
...
- [Videos](videos/index.md)
    ...
    - [ASP.NET SignalR-Videos](videos/getting-started/index.md)
        ...
        - [SignalR und Websockets](videos/getting-started/signalr-and-web-sockets.md)
