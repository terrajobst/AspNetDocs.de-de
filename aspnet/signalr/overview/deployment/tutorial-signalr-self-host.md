...
<span data-ttu-id="c19a7-127">Gründe für die nicht in IIS hosten umfassen:</span><span class="sxs-lookup"><span data-stu-id="c19a7-127">Reasons for not hosting in IIS include:</span></span>
