...
---
# <a name="understanding-and-handling-connection-lifetime-events-in-signalr-1x"></a>Verstehen und behandeln von Verbindungs Lebensdauer-Ereignissen in signalr 1. x
...
> 
> In diesem Artikel wird davon ausgegangen, dass Sie bereits über Kenntnisse zu signalr und Verbindungs Lebensdauer-Ereignissen verfügen. Eine Einführung in signalr finden Sie unter [signalr-Overview-Getting Started](index.md). Listen der Verbindungs Lebensdauer-Ereignisse finden Sie in den folgenden Ressourcen:
> 
> - [Behandeln von Verbindungs Lebensdauer-Ereignissen in der Hub-Klasse](index.md)
> - [Behandeln von Verbindungs Lebensdauer-Ereignissen in JavaScript-Clients](index.md)
> - [Behandeln von Verbindungs Lebensdauer-Ereignissen in .NET-Clients](index.md)
