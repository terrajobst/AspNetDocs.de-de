...
> 
> Der Artikel wird davon ausgegangen, dass Sie bereits über Grundkenntnisse der Objektlebensdauer-Ereignisse von SignalR und Verbindung verfügen. Eine Einführung zu SignalR finden Sie unter [SignalR – Übersicht – erste Schritte](index.md). Lebensdauer der Ereignisse der Verbindung finden Sie unter den folgenden Ressourcen:
> 
...
SignalR Version 1.1.1 keine integrierte Server-API für die Trennung der Clientverbindungen. Es gibt [Pläne für diese Funktion in Zukunft hinzuzufügen](https://github.com/SignalR/SignalR/issues/2101). Die einfachste Möglichkeit, trennen einen Client vom Server werden in der aktuellen Version von SignalR aus eine Disconnect-Methode auf dem Client implementieren und Aufrufen dieser Methode auf dem Server. Das folgende Codebeispiel zeigt eine Disconnect-Methode für einen JavaScript-Client mit den generierten Proxy.
