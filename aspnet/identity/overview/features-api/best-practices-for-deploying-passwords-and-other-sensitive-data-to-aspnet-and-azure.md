...
Da die Schlüssel-Wert-Paare für beide **app-Einstellungen** und **Verbindungszeichenfolgen** befinden sich in Umgebungsvariablen in Azure App Service, Entwickler, die alle Web-app-Frameworks (z. B. PHP) können problemlos verwenden Diese Werte abrufen. Finden Sie unter der Stefan Schackow [Windows Azure-Websites: Wie Zeichenfolgen und Verbindungszeichenfolgen](https://azure.microsoft.com/blog/2013/07/17/windows-azure-web-sites-how-application-strings-and-connection-strings-work/) Blog-Beitrag, der einen PHP-Ausschnitt zum Lesen von app-Einstellungen und Verbindungszeichenfolgen anzeigt.
