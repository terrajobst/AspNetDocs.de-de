...
8. Nach der erfolgreichen Anmeldung wird die ASP.NET-Website angezeigt, dass Sie authentifiziert wurden, indem Sie den Benutzernamen in der oberen rechten Ecke der Seite anzeigen.
   ...
   Wenn Sie eine Fehlermeldung erhalten, müssen Sie Folgendes tun: Wert darf nicht null oder leer sein. Parametername: LinkText ![](developing-aspnet-apps-with-windows-azure-active-directory/_static/image14.png)
...
Wenn Sie den folgenden Fehler erhalten: Wert darf nicht null oder leer sein. Parametername: LinkText
