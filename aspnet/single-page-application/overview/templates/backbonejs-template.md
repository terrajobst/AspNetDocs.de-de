...
## <a name="walkthrough-client-code"></a>Exemplarische Vorgehensweise: Clientcode
...
Die Sichten dienen modular aufgebaut sein: Jeder Abschnitt einer Seite verfügt über eine eigene dedizierte anzeigen. In einer einseitigen Anwendung ist es üblich, die Ansichten enthalten, die keine entsprechenden Controller verfügen. Sie können eine Sicht einschließen, durch den Aufruf `@Html.Partial('myView')`, aber dies mühsam. Um dies zu vereinfachen, die Vorlage definiert eine Hilfsmethode `IncludeClientViews`, rendert alle Ansichten in einem bestimmten Ordner:
