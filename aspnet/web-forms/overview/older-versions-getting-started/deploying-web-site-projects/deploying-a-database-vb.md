...
ms.locfileid: "57057627"
---
<a name="deploying-a-database-vb"></a>Bereitstellen einer Datenbank (VB)
====================
durch [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Code herunterladen](http://download.microsoft.com/download/E/6/F/E6FE3A1F-EE3A-4119-989A-33D1A9F6F6DD/ASPNET_Hosting_Tutorial_07_VB.zip) oder [PDF-Datei herunterladen](http://download.microsoft.com/download/C/3/9/C391A649-B357-4A7B-BAA4-48C96871FEA6/aspnet_tutorial07_DeployDB_vb.pdf)
...
[![Die Book Reviews-Webanwendung-s-Datenbank ist, besteht aus den vier Tabellen](deploying-a-database-vb/_static/image2.jpg)](deploying-a-database-vb/_static/image1.jpg) 

**Abbildung 1**: Die Book Reviews-Webanwendung-s-Datenbank ist, besteht aus den vier Tabellen ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image3.jpg))
...
[![Das Genre-Technologieseite](deploying-a-database-vb/_static/image5.jpg)](deploying-a-database-vb/_static/image4.jpg) 

**Abbildung 2**: Die Technologie "Genre"-Seite ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image6.jpg))


[![Die Überprüfung für bringen Sie sich selbst ASP.NET 3.5 in 24 Stunden](deploying-a-database-vb/_static/image8.jpg)](deploying-a-database-vb/_static/image7.jpg) 

**Abbildung 3**: Die Überprüfung für *bringen Sie sich ASP.NET 3.5 in 24 Stunden* ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image9.jpg))
...
[![Suchen Sie die Datenbank in der Datenbank-Explorer oder Server-Explorer](deploying-a-database-vb/_static/image11.jpg)](deploying-a-database-vb/_static/image10.jpg) 

**Abbildung 4**: Suchen Sie die Datenbank in der Datenbank-Explorer oder Server-Explorer ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image12.jpg))
...
[![Der Datenbankveröffentlichungs-Assistenten-Begrüßungsbildschirm](deploying-a-database-vb/_static/image14.jpg)](deploying-a-database-vb/_static/image13.jpg) 

**Abbildung 5**: Der Begrüßungsbildschirm der Datenbank veröffentlichen-Assistent ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image15.jpg))
...
> [!NOTE]
> Wenn Sie die Fehlermeldung "in der Datenbank keine Objekte vorhanden sind *DatabaseName* der Typen, die von diesem Assistenten skriptfähige" Wenn weiter auf dem Bildschirm in Abbildung 6 dargestellten klicken, stellen Sie sicher, dass der Pfad zu Ihrer Datenbankdatei nicht übermäßig lang ist. Wie im [Dieser Diskussionsbeitrag](http://www.codeplex.com/sqlhost/Thread/View.aspx?ThreadId=11014) auf der Seite des Datenbankveröffentlichungs-Assistent-Projekt, kann dieser Fehler auftreten, wenn der Pfad zur Datenbankdatei zu lang ist.


[![Der Datenbankveröffentlichungs-Assistenten-Begrüßungsbildschirm](deploying-a-database-vb/_static/image17.jpg)](deploying-a-database-vb/_static/image16.jpg) 

**Abbildung 6**: Der Begrüßungsbildschirm der Datenbank veröffentlichen-Assistent ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image18.jpg))
...
[![Skripterstellung für die Datenbank in eine Datei oder direkt in Ihre Webhostinganbieter veröffentlichen](deploying-a-database-vb/_static/image20.jpg)](deploying-a-database-vb/_static/image19.jpg) 

**Abbildung 7**: Skripterstellung für die Datenbank in eine Datei oder direkt in Ihre Webhostinganbieter veröffentlichen ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image21.jpg))
...
[![Geben Sie die Veröffentlichung Optionen](deploying-a-database-vb/_static/image23.jpg)](deploying-a-database-vb/_static/image22.jpg) 

**Abbildung 8**: Geben Sie Optionen für die Veröffentlichung ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image24.jpg))
...
[![Verbinden Sie mit Ihrem Web-Host-Anbieter-s-Datenbank-Server](deploying-a-database-vb/_static/image26.jpg)](deploying-a-database-vb/_static/image25.jpg) 

**Abbildung 9**: Eine Verbindung mit Ihrer Webhostinganbieter-s-Datenbank-Server herstellen ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image27.jpg))
...
[![Verbinden Sie mit Ihrem Web-Host-Anbieter-s-Datenbank-Server](deploying-a-database-vb/_static/image29.jpg)](deploying-a-database-vb/_static/image28.jpg) 

**Abbildung 10**: Eine Verbindung mit Ihrer Webhostinganbieter-s-Datenbank-Server herstellen ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image30.jpg))
...
[![Die Datenbankobjekte haben in der Produktionsdatenbank dupliziert](deploying-a-database-vb/_static/image32.jpg)](deploying-a-database-vb/_static/image31.jpg) 

**Abbildung 11**: Die Datenbank Objekte haben dupliziert wurde in der Produktionsdatenbank ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image33.jpg))


[![Die Produktionsdatenbank enthält die gleichen Daten wie in der Entwicklungsdatenbank](deploying-a-database-vb/_static/image35.jpg)](deploying-a-database-vb/_static/image34.jpg) 

**Abbildung 12**: Die Produktionsdatenbank enthält die gleichen Daten wie in der Entwicklungsdatenbank ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-a-database-vb/_static/image36.jpg))
