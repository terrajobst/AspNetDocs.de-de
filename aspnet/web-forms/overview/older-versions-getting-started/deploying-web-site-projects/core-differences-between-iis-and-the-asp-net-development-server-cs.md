...
Schließlich konfiguriert die Webanwendung zur Verwendung von Forms basierende Authentifizierung durch Aktualisieren der `Web.config` Datei im Stammverzeichnis, und Ersetzen Sie dabei:
