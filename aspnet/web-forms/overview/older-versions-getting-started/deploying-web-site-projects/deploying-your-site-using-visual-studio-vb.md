...
[![Tseine Website Tool zum Kopieren der Benutzeroberfläche ist in zwei Bereiche unterteilt](deploying-your-site-using-visual-studio-vb/_static/image2.png)](deploying-your-site-using-visual-studio-vb/_static/image1.png)
...
[![SAngeben der Ziel-Website](deploying-your-site-using-visual-studio-vb/_static/image5.png)](deploying-your-site-using-visual-studio-vb/_static/image4.png)
...
[![Aeine neue Seite mit dem Namen TT &lt;Code&gt;Privacy.aspx&lt;/code&gt; zum Stammordner der Website](deploying-your-site-using-visual-studio-vb/_static/image8.png)](deploying-your-site-using-visual-studio-vb/_static/image7.png)

**Abbildung 3**: Fügen Sie eine neue Seite mit dem Namen `Privacy.aspx` zum Stammordner der Website ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-your-site-using-visual-studio-vb/_static/image9.png))
...
[![Ter Tool zum Kopieren von Websites enthält neue &lt;Code&gt;Privacy.aspx&lt;/code&gt; Seite im linken Bereich](deploying-your-site-using-visual-studio-vb/_static/image11.png)](deploying-your-site-using-visual-studio-vb/_static/image10.png)
...
[![Ter Tool "Website kopieren" gibt an, dass die &lt;Code&gt;Privacy.aspx&lt;/code&gt; Seite wurde geändert.](deploying-your-site-using-visual-studio-vb/_static/image14.png)](deploying-your-site-using-visual-studio-vb/_static/image13.png)
...
[![SAngeben der Ziel-Website](deploying-your-site-using-visual-studio-vb/_static/image17.png)](deploying-your-site-using-visual-studio-vb/_static/image16.png)
...
[![Oibgeschützt, die die benötigten Dateien in der Produktionsumgebung veröffentlicht wurden](deploying-your-site-using-visual-studio-vb/_static/image20.png)](deploying-your-site-using-visual-studio-vb/_static/image19.png)
