...
ms.locfileid: "59396602"
---
# <a name="users-and-roles-on-the-production-website-c"></a>Benutzer und Rollen auf der Produktionswebsite (c#)
...
([Klicken Sie, um das Bild in voller Größe anzeigen](users-and-roles-on-the-production-website-cs/_static/image6.png))
...
([Klicken Sie, um das Bild in voller Größe anzeigen](users-and-roles-on-the-production-website-cs/_static/image9.png))
...
([Klicken Sie, um das Bild in voller Größe anzeigen](users-and-roles-on-the-production-website-cs/_static/image12.png))
...
In der [ *konfigurieren eine Website, dass verwendet Anwendungsdienste* Tutorial](configuring-a-website-that-uses-application-services-cs.md) ich hinzugefügt, dass eine Seite, um die `Admin` Ordner mit dem Namen `CreateAccount.aspx`. Auf dieser Seite können Sie einen Administrator ein neues Benutzerkonto mit dem Standort hinzufügen und angeben, ob der neu erstellte Benutzer in der Rolle "Administrator" ist (siehe **Abbildung 5**).
...
([Klicken Sie, um das Bild in voller Größe anzeigen](users-and-roles-on-the-production-website-cs/_static/image15.png))
