...
[![TIE-Kategorien und Produkte Zusammensetzung der Sitemap-s-Struktur](building-a-custom-database-driven-site-map-provider-vb/_static/image1.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image1.png)
...
[![CKonfigurieren der "ObjectDataSource" zum Zurückgeben von Kategorien mithilfe der GetCategories-Methode](building-a-custom-database-driven-site-map-provider-vb/_static/image4.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image3.png)
...
[![Su. a. die Dropdownlisten in der Update-, INSERT- und DELETE Registerkarten (keine)](building-a-custom-database-driven-site-map-provider-vb/_static/image5.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image5.png)
...
[![EACH Kategorie ist aufgeführten zusammen mit einem Ansicht Produkte-Link](building-a-custom-database-driven-site-map-provider-vb/_static/image7.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image7.png)
...
[![USE die ProductsBLL Klasse s GetProductsByCategoryID(categoryID) Methode](building-a-custom-database-driven-site-map-provider-vb/_static/image8.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image9.png)
...
[![USE die CategoryID Querystring-Feld für die CategoryID Parameter](building-a-custom-database-driven-site-map-provider-vb/_static/image9.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image11.png)
...
[![THE Getränke Namen, Preise und Lieferanten werden angezeigt](building-a-custom-database-driven-site-map-provider-vb/_static/image11.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image13.png)

**Abbildung 11**: Die Getränke Namen, Preise und Lieferanten werden angezeigt ([klicken Sie, um das Bild in voller Größe anzeigen](building-a-custom-database-driven-site-map-provider-vb/_static/image14.png))
...
[![CKonfigurieren Sie die GetProductByProductID(productID)-Methode mit dem ObjectDataSource-Steuerelement](building-a-custom-database-driven-site-map-provider-vb/_static/image12.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image15.png)

**Abbildung 12**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `GetProductByProductID(productID)` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](building-a-custom-database-driven-site-map-provider-vb/_static/image16.png))
...
[![CKonfigurieren der Parameter den Wert aus dem Querystring-Feld "ProductID" abrufen "ProductID"](building-a-custom-database-driven-site-map-provider-vb/_static/image13.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image17.png)
...
[![CHai Tee s Lieferanten, Kategorie, Preise und andere Informationen werden angezeigt](building-a-custom-database-driven-site-map-provider-vb/_static/image14.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image19.png)
...
[![EACH SiteMapNode verfügt über Eigenschaften wie Titel, Url, Schlüssel und usw.](building-a-custom-database-driven-site-map-provider-vb/_static/image16.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image15.gif)
...
[![ATT ein SiteMapPath an "default.aspx"](building-a-custom-database-driven-site-map-provider-vb/_static/image19.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image18.gif)

**Abbildung 16**: Fügen Sie ein SiteMapPath, `Default.aspx` ([klicken Sie, um das Bild in voller Größe anzeigen](building-a-custom-database-driven-site-map-provider-vb/_static/image20.gif))
...
[![Ter Breadcrumb verwendet die Standard-Siteübersichtsanbieter](building-a-custom-database-driven-site-map-provider-vb/_static/image22.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image21.gif)

**Abbildung 17**: Die Breadcrumb-Leiste wird der Standard-Siteübersichtsanbieter verwendet ([klicken Sie, um das Bild in voller Größe anzeigen](building-a-custom-database-driven-site-map-provider-vb/_static/image23.gif))
...
[![Ter Breadcrumb verwendet jetzt die benutzerdefinierte Site Map Provider NorthwindSiteMapProvider](building-a-custom-database-driven-site-map-provider-vb/_static/image25.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image24.gif)

**Abbildung 18**: Die Breadcrumb-Leiste verwendet jetzt die benutzerdefinierte Siteübersichtsanbieter `NorthwindSiteMapProvider` ([klicken Sie, um das Bild in voller Größe anzeigen](building-a-custom-database-driven-site-map-provider-vb/_static/image26.gif))
...
[![Ter Breadcrumb verwendet jetzt die benutzerdefinierte Site Map Provider NorthwindSiteMapProvider](building-a-custom-database-driven-site-map-provider-vb/_static/image27.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image21.png)

**Abbildung 19**: Die Breadcrumb-Leiste verwendet jetzt die benutzerdefinierte Siteübersichtsanbieter `NorthwindSiteMapProvider` ([klicken Sie, um das Bild in voller Größe anzeigen](building-a-custom-database-driven-site-map-provider-vb/_static/image22.png))
...
[![Ter Menu-Steuerelement werden die einzelnen Kategorien und Produkte aufgeführt](building-a-custom-database-driven-site-map-provider-vb/_static/image29.gif)](building-a-custom-database-driven-site-map-provider-vb/_static/image28.gif)

**Abbildung 20**: Der Menü-Steuerelement enthält jede der Kategorien und Produkte ([klicken Sie, um das Bild in voller Größe anzeigen](building-a-custom-database-driven-site-map-provider-vb/_static/image30.gif))
