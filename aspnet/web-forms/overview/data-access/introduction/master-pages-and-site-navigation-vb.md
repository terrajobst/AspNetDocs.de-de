...
title: Masterseiten und Sitenavigation (VB) | Microsoft-Dokumentation
...
ms.locfileid: "57061087"
---
<a name="master-pages-and-site-navigation-vb"></a>Masterseiten und Sitenavigation (VB)
====================
durch [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Beispiel-App herunter](http://download.microsoft.com/download/5/d/7/5d7571fc-d0b7-4798-ad4a-c976c02363ce/ASPNET_Data_Tutorial_3_VB.exe) oder [PDF-Datei herunterladen](master-pages-and-site-navigation-vb/_static/datatutorial03vb1.pdf)
...
Der erste Schritt ist die Masterseite für die Website zu erstellen. Derzeit nur das typisierte DataSet unserer Website besteht (`Northwind.xsd`in die `App_Code` Ordner), die BLL-Klassen (`ProductsBLL.vb`, `CategoriesBLL.vb`, und so weiter, alle in der `App_Code` Ordner), der Datenbank (`NORTHWND.MDF`in die `App_Data` Ordner ""), die Konfigurationsdatei (`Web.config`), und eine CSS-Stylesheet-Datei (`Styles.css`). Ich bereinigt diese Seiten und Dateien, die veranschaulichen, mit der DAL und der BLL aus den ersten beiden Tutorials, da wir diesen Beispielen ausführlich in zukünftigen Lernprogrammen überprüfen.


![Die Dateien in Ihrem Projekt](master-pages-and-site-navigation-vb/_static/image4.png)
...
![Ein Menü besteht aus zwei Repeater und etwas CSS](master-pages-and-site-navigation-vb/_static/image27.png)
...
![Die Breadcrumb-Leiste zeigt die aktuelle Seite und dessen Vorgänger auf der Website Sitezuordnungshierarchie](master-pages-and-site-navigation-vb/_static/image28.png)
