...
[![ADd SectionLevelTutorialListing.ascx Benutzersteuerelements in "default.aspx"](adding-a-gridview-column-of-radio-buttons-vb/_static/image2.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image1.png)
...
[![CErstellen eine neue "ObjectDataSource" mit dem Namen SuppliersDataSource](adding-a-gridview-column-of-radio-buttons-vb/_static/image4.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image3.png)

**Abbildung 4**: Erstellen Sie eine neue "ObjectDataSource" mit dem Namen `SuppliersDataSource` ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image4.png))


[![CKonfigurieren der SuppliersBLL-Klasse mit dem ObjectDataSource-Steuerelement](adding-a-gridview-column-of-radio-buttons-vb/_static/image5.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image5.png)

**Abbildung 5**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `SuppliersBLL` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image6.png))
...
[![CKonfigurieren der SuppliersBLL-Klasse mit dem ObjectDataSource-Steuerelement](adding-a-gridview-column-of-radio-buttons-vb/_static/image6.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image7.png)

**Abbildung 6**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `SuppliersBLL` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image8.png))


Auf der Registerkarte Updates wählen (keine) aus, und klicken Sie auf Weiter.


[![CKonfigurieren der SuppliersBLL-Klasse mit dem ObjectDataSource-Steuerelement](adding-a-gridview-column-of-radio-buttons-vb/_static/image7.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image9.png)

**Abbildung 7**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `SuppliersBLL` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image10.png))
...
[![USE USA als den Standardwert für das Land Parameter](adding-a-gridview-column-of-radio-buttons-vb/_static/image8.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image11.png)

**Abbildung 8**: Verwenden Sie die USA als den Standardwert für die `country` Parameter ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image12.png))
...
[![Ttypkonvertierungsverarbeitung Lieferanten aus den USA haben ihren Namen, Stadt und Land Informationen aufgelistet.](adding-a-gridview-column-of-radio-buttons-vb/_static/image9.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image13.png)
...
[![ATT ein RadioButton-Steuerelement für ItemTemplate verbleibt](adding-a-gridview-column-of-radio-buttons-vb/_static/image10.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image15.png)
...
[![Ter GridView s Optionsfelder nicht gruppiert sind.](adding-a-gridview-column-of-radio-buttons-vb/_static/image11.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image17.png)

**Abbildung 11**: Die Optionsfelder des GridView-s werden nicht gruppiert ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image18.png))
...
[![ATT ein Literalsteuerelement für ItemTemplate verbleibt](adding-a-gridview-column-of-radio-buttons-vb/_static/image12.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image19.png)
...
[![ADd einer Bezeichnung Web-Steuerelement über das GridView-Ansicht](adding-a-gridview-column-of-radio-buttons-vb/_static/image13.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image21.png)
...
[![Ter ChooseSupplierMsg Bezeichnung wird angezeigt, wenn kein Anbieter ausgewählt ist](adding-a-gridview-column-of-radio-buttons-vb/_static/image14.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image23.png)
...
[![Ter aktiviert Lieferanten s, die Produkte in ProductsForSupplierDetails.aspx angezeigt werden](adding-a-gridview-column-of-radio-buttons-vb/_static/image15.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image25.png)

**Abbildung 15**: Die s-Produkte von Lieferanten ausgewählt werden angezeigt, `ProductsForSupplierDetails.aspx` ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image26.png))
...
[![BSuchen der ProductsBySupplier GridView, um eine neue "ObjectDataSource"](adding-a-gridview-column-of-radio-buttons-vb/_static/image16.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image27.png)
...
[![CKonfigurieren Sie die GetProductsBySupplierID(supplierID)-Methode mit dem ObjectDataSource-Steuerelement](adding-a-gridview-column-of-radio-buttons-vb/_static/image17.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image29.png)

**Abbildung 17**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `GetProductsBySupplierID(supplierID)` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image30.png))


[![Su. a. die Dropdownlisten auf (keine) in der Update-, INSERT- und DELETE-Registerkarten](adding-a-gridview-column-of-radio-buttons-vb/_static/image18.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image31.png)
...
[![USE eine ControlParameter als Quelle-Parameter an die GridView s SelectedValue](adding-a-gridview-column-of-radio-buttons-vb/_static/image19.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image33.png)
...
[![Ter Produkte vom Bigfoot Brauereien finden Sie auf der gleichen Seite](adding-a-gridview-column-of-radio-buttons-vb/_static/image20.gif)](adding-a-gridview-column-of-radio-buttons-vb/_static/image35.png)

**Abbildung 20**: Die Produkte vom Bigfoot Brauereien finden Sie auf der gleichen Seite ([klicken Sie, um das Bild in voller Größe anzeigen](adding-a-gridview-column-of-radio-buttons-vb/_static/image36.png))
