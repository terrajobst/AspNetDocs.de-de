...
[![ADd SectionLevelTutorialListing.ascx Benutzersteuerelements in "default.aspx"](uploading-files-cs/_static/image2.gif)](uploading-files-cs/_static/image1.png)
...
[![Binär Daten kann im Dateisystem oder direkt in der Datenbank gespeichert werden](uploading-files-cs/_static/image4.gif)](uploading-files-cs/_static/image3.png)

**Abbildung 4**: Binäre Daten können im Dateisystem oder direkt in der Datenbank gespeichert werden ([klicken Sie, um das Bild in voller Größe anzeigen](uploading-files-cs/_static/image4.png))
...
[![ADd der Categories-Tabelle eine Spalte BrochurePath](uploading-files-cs/_static/image5.gif)](uploading-files-cs/_static/image5.png)
...
[![CErstellen Sie eine DataColumn mit dem Namen Bild ist, deren Datentyp System.Byte []](uploading-files-cs/_static/image6.gif)](uploading-files-cs/_static/image7.png)
...
[![UAktualisieren der Liste der Spalten in der SELECT-Anweisung auch zurückgeben BrochurePath](uploading-files-cs/_static/image7.gif)](uploading-files-cs/_static/image9.png)
...
[![SWählen Sie die SQL-Anweisungen Option](uploading-files-cs/_static/image8.gif)](uploading-files-cs/_static/image11.png)
...
[![SInce die Abfrage gibt einen Datensatz aus der Tabelle "Categories", wählen Sie die Zeilen zurückgibt auswählen](uploading-files-cs/_static/image9.gif)](uploading-files-cs/_static/image13.png)
...
[![CWählen Sie die Namen für die TableAdapter-Methoden aus](uploading-files-cs/_static/image10.gif)](uploading-files-cs/_static/image15.png)
...
[![ATT ein "FileUpload"-Steuerelement in die ASP.NET-Seite](uploading-files-cs/_static/image12.gif)](uploading-files-cs/_static/image17.png)
...
[![Ter Benutzer kann eine Datei zum Hochladen von ihrem Computer an den Server auswählen](uploading-files-cs/_static/image13.gif)](uploading-files-cs/_static/image19.png)
...
[![Ter Datei EvolutionValley.jpg hochgeladen wurde an den Webserver](uploading-files-cs/_static/image14.gif)](uploading-files-cs/_static/image21.png)
