...
[![Ean (Kategorie), sowie die Produkte, finden Sie](nested-data-web-controls-cs/_static/image2.png)](nested-data-web-controls-cs/_static/image1.png)
...
[![CKonfigurieren der "ObjectDataSource" die CategoriesBLL Klasse s GetCategories-Methode verwendet](nested-data-web-controls-cs/_static/image8.png)](nested-data-web-controls-cs/_static/image7.png)
...
[![EACH-Kategorie s Name und Beschreibung aufgelistet ist, getrennt durch eine horizontale Trennlinie](nested-data-web-controls-cs/_static/image11.png)](nested-data-web-controls-cs/_static/image10.png)
...
[![Tin der äußeren Repeater werden die einzelnen Kategorien aufgelistet; das Innere einer Listet die Produkte, für die Kategorie](nested-data-web-controls-cs/_static/image14.png)](nested-data-web-controls-cs/_static/image13.png)
