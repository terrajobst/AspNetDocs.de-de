...
[![Konfigurieren Sie die "ObjectDataSource", um den Assistenten CategoriesBLL verwenden](batch-updating-cs/_static/image8.gif)](batch-updating-cs/_static/image13.png)

**Abbildung 8**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `CategoriesBLL` Assistenten ([klicken Sie, um das Bild in voller Größe anzeigen](batch-updating-cs/_static/image14.png))
