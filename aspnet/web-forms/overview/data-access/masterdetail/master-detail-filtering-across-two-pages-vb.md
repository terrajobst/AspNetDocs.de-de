...
ms.locfileid: "59395354"
---
# <a name="masterdetail-filtering-across-two-pages-vb"></a>Filtern von Master-/Detailberichten über zwei Seiten (VB)

durch [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Beispiel-App herunter](http://download.microsoft.com/download/5/d/7/5d7571fc-d0b7-4798-ad4a-c976c02363ce/ASPNET_Data_Tutorial_9_VB.exe) oder [PDF-Datei herunterladen](master-detail-filtering-across-two-pages-vb/_static/datatutorial09vb1.pdf)
...
[![SWählen Sie die Klasse SuppliersBLL](master-detail-filtering-across-two-pages-vb/_static/image3.png)](master-detail-filtering-across-two-pages-vb/_static/image2.png)

**Abbildung 2**: Wählen Sie die `SuppliersBLL` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image4.png))


[![CKonfigurieren Sie die GetSuppliers()-Methode mit dem ObjectDataSource-Steuerelement](master-detail-filtering-across-two-pages-vb/_static/image6.png)](master-detail-filtering-across-two-pages-vb/_static/image5.png)

**Abbildung 3**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `GetSuppliers()` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image7.png))
...
[![ATT ein HyperLinkField an die GridView](master-detail-filtering-across-two-pages-vb/_static/image9.png)](master-detail-filtering-across-two-pages-vb/_static/image8.png)

**Abbildung 4**: Hinzufügen einer HyperLinkField an die GridView ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image10.png))
...
[![Su. a. die HyperLinkField des Text-Eigenschaft Produkte anzeigen](master-detail-filtering-across-two-pages-vb/_static/image12.png)](master-detail-filtering-across-two-pages-vb/_static/image11.png)

**Abbildung 5**: Legen Sie die HyperLinkField des `Text` Eigenschaft, um Produkte anzeigen ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image13.png))
...
[![CKonfigurieren der HyperLinkField sollen die richtige Link-URL basierend auf der SupplierID](master-detail-filtering-across-two-pages-vb/_static/image15.png)](master-detail-filtering-across-two-pages-vb/_static/image14.png)

**Abbildung 6**: Konfigurieren Sie die HyperLinkField für die Einbeziehung der richtige Link-URL basierend auf den `SupplierID` ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image16.png))
...
[![Ean Lieferanten Zeile enthält einen Ansicht-Produkte-Link](master-detail-filtering-across-two-pages-vb/_static/image18.png)](master-detail-filtering-across-two-pages-vb/_static/image17.png)

**Abbildung 7**: Jeder Lieferant Zeile enthält eine Ansichtsverknüpfung-Produkte ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image19.png))
...
[![ADd einen neuen "ObjectDataSource" mit dem Namen ProductsBySupplierDataSource](master-detail-filtering-across-two-pages-vb/_static/image21.png)](master-detail-filtering-across-two-pages-vb/_static/image20.png)

**Abbildung 8**: Hinzufügen einer neuen "ObjectDataSource" mit dem Namen `ProductsBySupplierDataSource` ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image22.png))


[![SWählen Sie die Klasse ProductsBLL](master-detail-filtering-across-two-pages-vb/_static/image24.png)](master-detail-filtering-across-two-pages-vb/_static/image23.png)

**Abbildung 9**: Wählen Sie die `ProductsBLL` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image25.png))


[![HDurchschn. "ObjectDataSource" Invoke-Methode der GetProductsBySupplierID(supplierID)](master-detail-filtering-across-two-pages-vb/_static/image27.png)](master-detail-filtering-across-two-pages-vb/_static/image26.png)

**Abbildung 10**: Haben Sie die "ObjectDataSource" Aufrufen der `GetProductsBySupplierID(supplierID)` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image28.png))
...
[![PInde die SupplierID Parameterwert aus dem SupplierID Querystring-Wert](master-detail-filtering-across-two-pages-vb/_static/image30.png)](master-detail-filtering-across-two-pages-vb/_static/image29.png)

**Abbildung 11**: Auffüllen der *`supplierID`* Parameterwert aus dem `SupplierID` Querystring-Wert ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image31.png))


Das ist schon alles! Abbildung 12 zeigt die `ProductsForSupplierDetails.aspx` Seite besucht haben, indem Sie auf den Link Tokyo Traders aus `SupplierListMaster.aspx`.


[![Ter die Produkte, die von der Tokio Traders bereitgestellt werden angezeigt](master-detail-filtering-across-two-pages-vb/_static/image33.png)](master-detail-filtering-across-two-pages-vb/_static/image32.png)

**Abbildung 12**: Die Produkte, die von der Tokio Traders bereitgestellt werden angezeigt ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image34.png))
...
[![SWählen Sie die Klasse SuppliersBLL](master-detail-filtering-across-two-pages-vb/_static/image36.png)](master-detail-filtering-across-two-pages-vb/_static/image35.png)

**Abbildung 13**: Wählen Sie die `SuppliersBLL` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image37.png))


[![HDurchschn. "ObjectDataSource" Invoke-Methode der GetSupplierBySupplierID(supplierID)](master-detail-filtering-across-two-pages-vb/_static/image39.png)](master-detail-filtering-across-two-pages-vb/_static/image38.png)

**Abbildung 14**: Haben Sie die "ObjectDataSource" Aufrufen der `GetSupplierBySupplierID(supplierID)` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image40.png))
...
[![PInde die SupplierID Parameterwert aus dem SupplierID Querystring-Wert](master-detail-filtering-across-two-pages-vb/_static/image42.png)](master-detail-filtering-across-two-pages-vb/_static/image41.png)

**Abbildung 15**: Auffüllen der *`supplierID`* Parameterwert aus dem `SupplierID` Querystring-Wert ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image43.png))
...
[![Ter die Liste der Produkte enthält eine Zusammenfassung über die Lieferanten](master-detail-filtering-across-two-pages-vb/_static/image45.png)](master-detail-filtering-across-two-pages-vb/_static/image44.png)

**Abbildung 16**: Die Liste der Produkte enthält eine Zusammenfassung über die Lieferanten ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image46.png))
...
[![ATT ein HyperLink-Steuerelement, um den Benutzer wieder zum SupplierListMaster.aspx übernehmen](master-detail-filtering-across-two-pages-vb/_static/image48.png)](master-detail-filtering-across-two-pages-vb/_static/image47.png)

**Abbildung 17**: Fügen Sie ein HyperLink-Steuerelement, um den Benutzer zurück zur nutzen `SupplierListMaster.aspx` ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image49.png))
...
[![UBen tzer werden darüber informiert, dass der Lieferant alle Produkte bieten keine](master-detail-filtering-across-two-pages-vb/_static/image51.png)](master-detail-filtering-across-two-pages-vb/_static/image50.png)

**Abbildung 18**: Benutzer werden darüber informiert, dass der Lieferant keine Produkte bereitstellt ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-vb/_static/image52.png))
