...
[![SWählen Sie die Klasse SuppliersBLL](master-detail-filtering-across-two-pages-cs/_static/image3.png)](master-detail-filtering-across-two-pages-cs/_static/image2.png)
...
[![CKonfigurieren Sie die GetSuppliers()-Methode mit dem ObjectDataSource-Steuerelement](master-detail-filtering-across-two-pages-cs/_static/image6.png)](master-detail-filtering-across-two-pages-cs/_static/image5.png)

**Abbildung 3**: Konfigurieren Sie das "ObjectDataSource" Verwenden der `GetSuppliers()` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-cs/_static/image7.png))
...
[![ATT ein HyperLinkField an die GridView](master-detail-filtering-across-two-pages-cs/_static/image9.png)](master-detail-filtering-across-two-pages-cs/_static/image8.png)
...
[![Su. a. die HyperLinkField des Text-Eigenschaft Produkte anzeigen](master-detail-filtering-across-two-pages-cs/_static/image12.png)](master-detail-filtering-across-two-pages-cs/_static/image11.png)
...
[![CKonfigurieren der HyperLinkField sollen die richtige Link-URL basierend auf der SupplierID](master-detail-filtering-across-two-pages-cs/_static/image15.png)](master-detail-filtering-across-two-pages-cs/_static/image14.png)

**Abbildung 6**: Konfigurieren Sie die HyperLinkField für die Einbeziehung der richtige Link-URL basierend auf den `SupplierID` ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-cs/_static/image16.png))
...
[![Ean Lieferanten Zeile enthält einen Ansicht-Produkte-Link](master-detail-filtering-across-two-pages-cs/_static/image18.png)](master-detail-filtering-across-two-pages-cs/_static/image17.png)

**Abbildung 7**: Jeder Lieferant Zeile enthält eine Ansichtsverknüpfung-Produkte ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-cs/_static/image19.png))
...
[![ADd einen neuen "ObjectDataSource" mit dem Namen ProductsBySupplierDataSource](master-detail-filtering-across-two-pages-cs/_static/image21.png)](master-detail-filtering-across-two-pages-cs/_static/image20.png)
...
[![SWählen Sie die Klasse ProductsBLL](master-detail-filtering-across-two-pages-cs/_static/image24.png)](master-detail-filtering-across-two-pages-cs/_static/image23.png)
...
[![HDurchschn. "ObjectDataSource" Invoke-Methode der GetProductsBySupplierID(supplierID)](master-detail-filtering-across-two-pages-cs/_static/image27.png)](master-detail-filtering-across-two-pages-cs/_static/image26.png)
...
[![PInde die SupplierID Parameterwert aus dem SupplierID Querystring-Wert](master-detail-filtering-across-two-pages-cs/_static/image30.png)](master-detail-filtering-across-two-pages-cs/_static/image29.png)
...
[![Ter die Produkte, die von der Tokio Traders bereitgestellt werden angezeigt](master-detail-filtering-across-two-pages-cs/_static/image33.png)](master-detail-filtering-across-two-pages-cs/_static/image32.png)

**Abbildung 12**: Die Produkte, die von der Tokio Traders bereitgestellt werden angezeigt ([klicken Sie, um das Bild in voller Größe anzeigen](master-detail-filtering-across-two-pages-cs/_static/image34.png))
...
[![SWählen Sie die Klasse SuppliersBLL](master-detail-filtering-across-two-pages-cs/_static/image36.png)](master-detail-filtering-across-two-pages-cs/_static/image35.png)
...
[![HDurchschn. "ObjectDataSource" Invoke-Methode der GetSupplierBySupplierID(supplierID)](master-detail-filtering-across-two-pages-cs/_static/image39.png)](master-detail-filtering-across-two-pages-cs/_static/image38.png)
...
[![PInde die SupplierID Parameterwert aus dem SupplierID Querystring-Wert](master-detail-filtering-across-two-pages-cs/_static/image42.png)](master-detail-filtering-across-two-pages-cs/_static/image41.png)
...
[![Ter die Liste der Produkte enthält eine Zusammenfassung über die Lieferanten](master-detail-filtering-across-two-pages-cs/_static/image45.png)](master-detail-filtering-across-two-pages-cs/_static/image44.png)
...
[![ATT ein HyperLink-Steuerelement, um den Benutzer wieder zum SupplierListMaster.aspx übernehmen](master-detail-filtering-across-two-pages-cs/_static/image48.png)](master-detail-filtering-across-two-pages-cs/_static/image47.png)
...
[![UBen tzer werden darüber informiert, dass der Lieferant alle Produkte bieten keine](master-detail-filtering-across-two-pages-cs/_static/image51.png)](master-detail-filtering-across-two-pages-cs/_static/image50.png)
