...
[Beispiel-App herunter](http://download.microsoft.com/download/4/a/7/4a7a3b18-d80e-4014-8e53-a6a2427f0d93/ASPNET_Data_Tutorial_59_CS.exe) oder [PDF-Datei herunterladen](caching-data-in-the-architecture-cs/_static/datatutorial59cs1.pdf)
...
Der Unterschied in dieser zweiten falschen Codeausschnitt ist, statt einen Verweis auf das zwischengespeicherte Element in einer lokalen Variablen speichern, das dem Datencache erfolgt direkt in die Auswertung der Anweisung *und* in die `return`. Stellen Sie sich vor, wenn dieser Code erreicht wird, `Cache["key"]` nicht`null`, jedoch bevor die `return` Anweisung erreicht wird, wird das System entfernt *Schlüssel* aus dem Cache. In diesem seltenen Fall, gibt der Code eine `null` Wert anstatt ein Objekt des erwarteten Typs.
...
[![Ter ProductsCL-Klasse befindet sich in der Dropdown-Liste Business](caching-data-in-the-architecture-cs/_static/image5.png)](caching-data-in-the-architecture-cs/_static/image4.png)
...
[![Ter aufgelistet ProductsCL Klassenmethoden s in den Dropdownlisten](caching-data-in-the-architecture-cs/_static/image8.png)](caching-data-in-the-architecture-cs/_static/image7.png)
...
Diese tutorialreihe wurde durch viele hilfreiche Reviewer überprüft. Führendes Prüfer für dieses Tutorial wurde Teresa Murph. Meine zukünftigen MSDN-Artikeln überprüfen möchten? Wenn dies der Fall ist, löschen Sie mir eine Linie an [ mitchell@4GuysFromRolla.com.](mailto:mitchell@4GuysFromRolla.com)
