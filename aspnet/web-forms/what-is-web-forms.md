...
- **Sicherheit**– ein wichtiger Bestandteil der Entwicklung einer Anwendung sichereren wird, die Bedrohungen, zu verstehen. Microsoft hat eine Möglichkeit zum Kategorisieren von Bedrohungen entwickelt: Spoofing, Manipulation, Nichtanerkennung, Offenlegung von Informationen, Denial of Service, Rechteerweiterungen (STRIDE). In ASP.NET Web Forms können Sie hinzufügen, Erweiterungspunkte und Konfigurationsoptionen, mit die Sie verschiedene Sicherheitsverhalten in ASP.NET Web Forms anpassen können.
