...
Erfahren Sie, wie in der ASP.NET AJAX Control Toolkit einen ConfirmButton-Extender eine einfache Möglichkeit zum Hinzufügen ein Bestätigungsdialogfeld mit dem Klickereignis einer Schaltfläche, LinkButton oder ImageButton-Steuerelements bereitstellt. Dadurch erhalten Benutzer mit der Option zum Abbrechen einer bevorstehenden Aktion.

[&#9654;Sehen Sie sich Video (3 Minuten)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-use-the-aspnet-ajax-confirmbutton-extender)

> [!div class="step-by-step"]
> [Zurück](how-do-i-get-started-with-the-aspnet-ajax-animation-extender-control.md)
> [Weiter](how-do-i-use-the-aspnet-ajax-slider-control.md)
