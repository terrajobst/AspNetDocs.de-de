...
Sie erhalten einen kurzen Überblick über die Einbindung von ASP.NET AJAX in Visual Studio 2008 (Orcas) und .NET 3,5. Dies wird mithilfe von Visual Studio 2008 und dem Aufbau der Website Anwendung veranschaulicht.

[&#9654;Video ansehen (9 Minuten)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-ajax-support-in-visual-studio-2008)

> [!div class="step-by-step"]
> [Weiter](adding-ajax-functionality-to-an-existing-aspnet-page.md)
