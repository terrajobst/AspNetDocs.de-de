...
| Vorgänge | -Wie einfach ist die Plattform zum Bereitstellen und Ausführen in Azure? PaaS? IaaS? Linux? Table Storage und SQL-Datenbank können in Azure problemlos eingerichtet werden. Plattformen, die nicht in Azure-Weblösungen integriert sind, erfordern mehr Aufwand. |
