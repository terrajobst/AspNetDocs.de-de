...
- [ASP.NET MVC 3 RTM (13 Januar 2011)](#MVC3RTM)
    ...
    - [Ändern Sie: Die Version von jQuery-Benutzeroberfläche aktualisiert auf 1.8.7](#RTM-1)
    - [Ändern Sie: Der Standardwert ModelMetadataProvider an DataAnnotationsModelMetadataProvider geändert](#RTM-2)
...
<a id="RTM-1"></a>
### <a name="change-updated-the-version-of-jquery-ui-to-187"></a>Ändern Sie: Die Version von jQuery-Benutzeroberfläche aktualisiert auf 1.8.7
...
<a id="RTM-2"></a>
### <a name="change-changed-the-default-modelmetadataprovider-back-to-dataannotationsmodelmetadataprovider"></a>Ändern Sie: Der Standardwert ModelMetadataProvider an DataAnnotationsModelMetadataProvider geändert
...
<a id="RTM-3"></a>
### <a name="fixed-pasting-part-of-a-razor-expression-that-contains-whitespace-results-in-it-being-reversed"></a>Fest: Teil einer Razor-Ausdruck einfügen, die Leerzeichen Ergebnisse darin wird umgekehrt enthält
...
<a id="RTM-4"></a>
### <a name="fixed-renaming-a-razor-file-that-is-opened-in-the-editor-disables-syntax-colorization-and-intellisense"></a>Fest: Umbenennen einer Razor-Datei, die im Editor geöffnet wird deaktiviert, farbige syntaxhervorhebung und IntelliSense
...
In früheren Versionen der *@model* Deklaration am oberen Rand einer Ansicht der gerenderten HTML-Ausgabe eine leere Zeile hinzugefügt. Dies wurde behoben, damit die Deklaration kein Leerraum einleitet.
