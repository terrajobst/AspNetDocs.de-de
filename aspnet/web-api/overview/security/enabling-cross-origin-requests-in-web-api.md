...
Die **[EnableCors]** Attribut implementiert die **ICorsPolicyProvider** Schnittstelle. Sie können Ihre eigene Implementierung bereitstellen, indem Sie eine abgeleitete Klasse erstellen **Attribut** und implementiert **ICorsPolicyProvider**.
