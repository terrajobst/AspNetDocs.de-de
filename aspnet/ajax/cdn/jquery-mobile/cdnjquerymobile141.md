...
ms.locfileid: "59394106"
---
# <a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="608a9-102">jQuery Mobile 1.4.1 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="608a9-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="608a9-103">JQuery Mobile 1.4.1-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="608a9-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
