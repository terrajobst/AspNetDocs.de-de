...
ms.locfileid: "78453615"
---
# <a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="ecaf5-102">jQuery Mobile 1.4.1 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="ecaf5-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="ecaf5-103">Die jQuery Mobile 1.4.1-Bibliothek umfasst die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="ecaf5-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
