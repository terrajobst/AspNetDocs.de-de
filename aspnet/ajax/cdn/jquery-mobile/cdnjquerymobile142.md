...
ms.locfileid: "57030697"
---
<a name="jquery-mobile-142-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="db705-102">jQuery Mobile 1.4.2 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="db705-102">jQuery Mobile 1.4.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="db705-103">JQuery Mobile 1.4.2-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="db705-103">The jQuery Mobile 1.4.2 library includes the following files:</span></span>
