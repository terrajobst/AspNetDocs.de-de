...
ms.locfileid: "59402080"
---
# <a name="jquery-mobile-101-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="825b1-102">jQuery Mobile 1.0.1 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="825b1-102">jQuery Mobile 1.0.1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="825b1-103">JQuery Mobile 1.0.1-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="825b1-103">The jQuery Mobile 1.0.1 library includes the following files:</span></span>
