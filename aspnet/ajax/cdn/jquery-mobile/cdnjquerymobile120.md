...
ms.locfileid: "57043177"
---
<a name="jquery-mobile-120-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="878d6-102">jQuery Mobile 1.2.0 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="878d6-102">jQuery Mobile 1.2.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="878d6-103">JQuery Mobile 1.2.0-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="878d6-103">The jQuery Mobile 1.2.0 library includes the following files:</span></span>
