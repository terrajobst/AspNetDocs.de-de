...
ms.locfileid: "59394080"
---
# <a name="jquery-mobile-10-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="62fb1-102">jQuery Mobile 1.0 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="62fb1-102">jQuery Mobile 1.0 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="62fb1-103">JQuery Mobile 1.0-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="62fb1-103">The jQuery Mobile 1.0 library includes the following files:</span></span>
