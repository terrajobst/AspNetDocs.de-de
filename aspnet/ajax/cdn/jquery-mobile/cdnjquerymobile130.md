...
ms.locfileid: "78453855"
---
# <a name="jquery-mobile-130-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="bbf86-102">jQuery Mobile 1.3.0 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="bbf86-102">jQuery Mobile 1.3.0 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="bbf86-103">Die jQuery Mobile 1.3.0-Bibliothek umfasst die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="bbf86-103">The jQuery Mobile 1.3.0 library includes the following files:</span></span>
