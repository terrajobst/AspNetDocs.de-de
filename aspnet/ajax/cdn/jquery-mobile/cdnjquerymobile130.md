...
ms.locfileid: "59390999"
---
# <a name="jquery-mobile-130-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="09592-102">jQuery Mobile 1.3.0 für das Microsoft AJAX CDN</span><span class="sxs-lookup"><span data-stu-id="09592-102">jQuery Mobile 1.3.0 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="09592-103">JQuery Mobile 1.3.0-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="09592-103">The jQuery Mobile 1.3.0 library includes the following files:</span></span>
