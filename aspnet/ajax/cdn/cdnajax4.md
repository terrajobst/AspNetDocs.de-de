...
ms.locfileid: "59419950"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="13c6a-102">ASP.NET Web Forms und AJAX 4</span><span class="sxs-lookup"><span data-stu-id="13c6a-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="13c6a-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="13c6a-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="13c6a-104">Hinweis: Die Globalisierung von Skripts wie z.B. "fr"-FR.js, finden Sie im folgenden Ordner:</span><span class="sxs-lookup"><span data-stu-id="13c6a-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
