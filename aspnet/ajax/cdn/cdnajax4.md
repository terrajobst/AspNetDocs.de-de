...
ms.locfileid: "78454167"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="a3af7-102">ASP.NET Web Forms und AJAX 4</span><span class="sxs-lookup"><span data-stu-id="a3af7-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="a3af7-103">Die folgenden Dateien werden auf dem CDN gehostet:</span><span class="sxs-lookup"><span data-stu-id="a3af7-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="a3af7-104">Hinweis: die Globalisierungs Skripts, wie z. b. fr-fr. js, finden Sie im folgenden Ordner:</span><span class="sxs-lookup"><span data-stu-id="a3af7-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
