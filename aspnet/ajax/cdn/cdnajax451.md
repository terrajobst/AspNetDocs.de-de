...
ms.locfileid: "59414542"
---
# <a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="4e050-102">ASP.NET Web Forms und AJAX 4.5.1</span><span class="sxs-lookup"><span data-stu-id="4e050-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>

<span data-ttu-id="4e050-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="4e050-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="4e050-104">Hinweis: Die Globalisierung von Skripts wie z.B. "fr"-FR.js, finden Sie im folgenden Ordner:</span><span class="sxs-lookup"><span data-stu-id="4e050-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
