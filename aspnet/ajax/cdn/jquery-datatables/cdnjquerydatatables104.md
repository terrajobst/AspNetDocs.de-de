...
ms.locfileid: "59414529"
---
# <a name="jquery-datatables-1104"></a><span data-ttu-id="a2f54-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="a2f54-102">jQuery DataTables 1.10.4</span></span>

<span data-ttu-id="a2f54-103">Die folgenden Dateien für die jQuery-DataTables-Plug-Ins, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="a2f54-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
