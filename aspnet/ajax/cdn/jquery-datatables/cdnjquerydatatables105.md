...
ms.locfileid: "59415933"
---
# <a name="jquery-datatables-1105"></a><span data-ttu-id="843a9-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="843a9-102">jQuery DataTables 1.10.5</span></span>

<span data-ttu-id="843a9-103">Die folgenden Dateien für die jQuery-DataTables-Plug-Ins, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="843a9-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
