...
title: jQuery-DataTables 1.9.3 | Microsoft-Dokumentation
...
ms.locfileid: "59383771"
---
# <a name="jquery-datatables-193"></a><span data-ttu-id="8e070-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="8e070-102">jQuery DataTables 1.9.3</span></span>

<span data-ttu-id="8e070-103">Die folgenden Dateien für die jQuery-DataTables-Plug-Ins, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="8e070-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
