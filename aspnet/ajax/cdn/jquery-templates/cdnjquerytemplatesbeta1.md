...
---
# <a name="jquery-templates-beta-1"></a><span data-ttu-id="02eff-102">jQuery Templates Beta 1</span><span class="sxs-lookup"><span data-stu-id="02eff-102">jQuery Templates Beta 1</span></span>

<span data-ttu-id="02eff-103">Die jQuery-Vorlagen-Plug-in enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="02eff-103">The jQuery Templates plugin includes the following files:</span></span>
