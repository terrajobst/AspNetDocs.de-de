...
ms.locfileid: "57050907"
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="d2ac0-102">jquery.validate Version 1.8</span><span class="sxs-lookup"><span data-stu-id="d2ac0-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="d2ac0-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="d2ac0-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="d2ac0-104">Lokalisierung von Dateien auf https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js , in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="d2ac0-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
