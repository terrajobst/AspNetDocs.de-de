...
ms.locfileid: "57056057"
---
<a name="jquery-validation-1100"></a><span data-ttu-id="ec098-102">jQuery Validation 1.10.0</span><span class="sxs-lookup"><span data-stu-id="ec098-102">jQuery Validation 1.10.0</span></span>
====================
<span data-ttu-id="ec098-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="ec098-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="ec098-104">Lokalisierung von Dateien auf https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js , in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="ec098-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js where ## is the loc code.</span></span>
