...
ms.locfileid: "57053397"
---
<a name="jquery-validation-1120"></a><span data-ttu-id="9f3f4-102">jQuery Validation 1.12.0</span><span class="sxs-lookup"><span data-stu-id="9f3f4-102">jQuery Validation 1.12.0</span></span>
====================
<span data-ttu-id="9f3f4-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="9f3f4-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="9f3f4-104">Lokalisierung von Dateien auf https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js , in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="9f3f4-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js where ## is the loc code.</span></span>
