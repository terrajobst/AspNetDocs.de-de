...
title: jQuery-Validierung 1.17.0 | Microsoft-Dokumentation
author: guardrex
description: ''
ms.author: riande
ms.date: 10/14/2017
...
ms.locfileid: "59389699"
---
# <a name="jquery-validation-1170"></a><span data-ttu-id="c6180-102">jQuery Validation 1.17.0</span><span class="sxs-lookup"><span data-stu-id="c6180-102">jQuery Validation 1.17.0</span></span>

<span data-ttu-id="c6180-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="c6180-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c6180-104">Lokalisierung von Dateien auf https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js , in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="c6180-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
