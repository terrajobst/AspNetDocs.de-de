...
ms.locfileid: "78472803"
---
# <a name="jquery-validation-1150"></a><span data-ttu-id="ce7a7-102">jQuery Validation 1.15.0</span><span class="sxs-lookup"><span data-stu-id="ce7a7-102">jQuery Validation 1.15.0</span></span>

<span data-ttu-id="ce7a7-103">Die folgenden Dateien werden auf dem CDN gehostet:</span><span class="sxs-lookup"><span data-stu-id="ce7a7-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="ce7a7-104">Lokalisierungsdateien bei https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js, wobei # # der Loc-Code ist.</span><span class="sxs-lookup"><span data-stu-id="ce7a7-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
