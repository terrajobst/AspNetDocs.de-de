...
ms.locfileid: "57054957"
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="76aee-102">jquery.validate Version 1.9</span><span class="sxs-lookup"><span data-stu-id="76aee-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="76aee-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="76aee-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="76aee-104">Lokalisierung von Dateien auf https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js , in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="76aee-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
