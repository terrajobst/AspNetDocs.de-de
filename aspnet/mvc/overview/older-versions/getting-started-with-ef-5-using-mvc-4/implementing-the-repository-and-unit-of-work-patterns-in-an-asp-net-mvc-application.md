...
Sie wird nicht in dieser tutorialreihe Komponententests erstellen. Eine Einführung in die testgesteuerte Entwicklung mit einer MVC-Anwendung, die das Repository-Muster verwendet werden soll, finden Sie unter [Exemplarische Vorgehensweise: Verwendung von TDD mit ASP.NET MVC](https://msdn.microsoft.com/library/ff847525.aspx). Weitere Informationen über das Repositorymuster finden Sie unter den folgenden Ressourcen:
