...
- Domänencontroller: Klassen, die eingehende URL-Anforderungen an die Anwendung verarbeiten rufen Modelldaten, und geben Sie dann die Vorlagen anzeigen, die eine Antwort an den Client zu rendern.
