...
1. *items*: Ein ["IEnumerable"](https://msdn.microsoft.com/library/system.collections.ienumerable.aspx) mit den Elementen in der Liste. Im obigen Beispiel wird die Liste der Genres von zurückgegebenen `db.Genres`.
...
![](examining-how-aspnet-mvc-scaffolds-the-dropdownlist-helper/_static/image7.png)sein.
