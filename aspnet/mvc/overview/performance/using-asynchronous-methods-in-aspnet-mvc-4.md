...
- *Mvc4Async*: Das ASP.NET MVC 4-Projekt, das in diesem Tutorial verwendeten Code enthält. Führt Sie Web-API-Aufrufe für die **WebAPIpgw** Service.
...
- *WebAppAsync*: Das ASP.NET Web Forms-Projekt in ein anderes Tutorial verwendet.
