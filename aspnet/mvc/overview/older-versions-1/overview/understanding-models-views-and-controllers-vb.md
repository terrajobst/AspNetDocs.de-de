...
Ein Controller ist nur eine Klasse (z. B. eine Visual Basic oder c#-Klasse). Die ASP.NET MVC-beispielanwendung enthält einen Controller namens HomeController.vb befindet sich im Ordner "Controllers". Der Inhalt der Datei HomeController.vb wird im Codebeispiel 2 reproduziert.
