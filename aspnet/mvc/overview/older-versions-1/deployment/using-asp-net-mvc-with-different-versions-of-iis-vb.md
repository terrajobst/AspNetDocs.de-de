...
title: Verwenden von ASP.NET MVC mit verschiedenen Versionen von IIS (VB) | Microsoft-Dokumentation
author: microsoft
...
[![des Dialog Felds "Neues Projekt"](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image1.jpg)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image1.png)

**Abbildung 1**: Erkennen des Anforderungs Verarbeitungsmodus ([Klicken Sie, um das Bild in voller Größe anzuzeigen](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image2.png))
...
[![des Dialog Felds "Neues Projekt"](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image2.jpg)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image3.png)

**Abbildung 2**: der Fehler "404 nicht gefunden" wird empfangen ([Klicken Sie, um das Bild in voller Größe anzuzeigen](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image4.png))
...
[![des Dialog Felds "Neues Projekt"](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image3.jpg)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image5.png)

**Abbildung 3**: Erstellen einer Platzhalter Skript Zuordnung mit IIS 7,0 ([Klicken Sie, um das Bild in voller Größe anzuzeigen](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image6.png))
...
[![des Dialog Felds "Neues Projekt"](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image4.jpg)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image7.png)

**Abbildung 4**: Erstellen einer Platzhalter Skript Zuordnung mit IIS 6,0 ([Klicken Sie, um das Bild in voller Größe anzuzeigen](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image8.png))
...
[![des Dialog Felds "Neues Projekt"](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image5.jpg)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image9.png)

**Abbildung 5**: fehlender Fehler bei der Stamm Route ([Klicken Sie, um das Bild in voller Größe anzuzeigen](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image10.png))
