...
title: Validierung mit den Validierungs Steuerelementen für Daten Anmerkungen (C#) | Microsoft-Dokumentation
author: microsoft
...
**Abbildung 1**: Hinzufügen eines Verweises auf den Modell Binder für Daten Anmerkungen ([Klicken Sie, um das Bild in voller Größe anzuzeigen](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Diese Codezeile registriert ataannotationsmodelbinder als Standardmodell Binder für die gesamte ASP.NET MVC-Anwendung.
...
Codebeispiel **4**: models\muvie.cs
...
**Abbildung 6**: Verwenden von Validierungs Steuerelemente mit dem Entity Framework ([Klicken Sie, um das Bild in voller Größe anzuzeigen](validation-with-the-data-annotation-validators-cs/_static/image14.png))
