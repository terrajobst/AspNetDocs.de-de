...
**Codebeispiel 1 – Controllers\MovieController.vb**

[!code-vb[Main](displaying-a-table-of-database-data-vb/samples/sample1.vb)]

In Codebeispiel 1 ist die MoviesDBEntities-Klasse verwendet, um die Datenbank MoviesDB darzustellen. Der Ausdruck *Entitäten. MovieSet.ToList()* gibt den Satz aller Filme aus der Tabelle der Datenbank Filme.
...
Die Ansicht in Listing 4 enthält eine For Each-Schleife, die alle Filme durchläuft. Für jeden Film wird der partiellen MovieTemplate verwendet, um den Film zu formatieren. Die MovieTemplate wird durch Aufrufen der Hilfsmethode RenderPartial() gerendert.
