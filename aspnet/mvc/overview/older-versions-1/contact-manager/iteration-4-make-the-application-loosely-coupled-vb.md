...
---
# <a name="iteration-4--make-the-application-loosely-coupled-vb"></a>Iterations #4 – Festlegen der Anwendung lose gekoppelt (VB)
...
**Codebeispiel 1: models\icontactmanagerrepositoriy.vb**
...
**Codebeispiel 2: models\entitycontactmanagerrepositorien.vb**
...
**Codebeispiel 4: models\contactmanagerservice.vb**
...
**Auflisten 5: models\icontactmanagerservice.vb**
...
**Auflisten 6-controllers\contactcontroller.vb**
...
**Codebeispiel 7: models\validation\modelstatewrapper.vb**

[!code-vb[Main](iteration-4-make-the-application-loosely-coupled-vb/samples/sample7.vb)]

**Auflisten von 8-models\validation\ivalidationditionary.vb**
