...
Unsere "Edit.aspx" ansichtsvorlage verwendet mehrere "HTML-Hilfsmethoden" zur Verfügung: Html.ValidationSummary(), Html.BeginForm(), Html.TextBox(), and Html.ValidationMessage(). Zusätzlich zum Generieren von HTML-Markup für uns, diese Hilfsmethoden bieten integrierte Verarbeitung und Validierung unterstützen.
