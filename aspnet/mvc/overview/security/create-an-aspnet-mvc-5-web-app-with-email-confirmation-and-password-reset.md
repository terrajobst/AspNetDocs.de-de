...
Die Anweisungen in diesem Abschnitt sind nicht aktuell. Finden Sie unter [Konfigurieren von SendGrid e-Mail-Anbieter](/aspnet/core/security/authentication/accconfirm#configure-email-provider) Anweisungen aktualisiert.
