...
Die Videos untersucht die Verwendung der Seitenprüfung in ASP.NET MVC-Webanwendungen. [Lesen Sie das tutorial](../../overview/views/using-page-inspector-in-aspnet-mvc.md)

[&#9654;Sehen Sie sich Video (6 Minuten)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/using-page-inspector-in-aspnet-mvc)
