...
> <span data-ttu-id="fd1b9-268">Bei der Erstellung einer **ApplicationPart** Objekt, stellen Sie sicher, dass die eingebetteten Ressourcen, die zugeordnet **ApplicationPart** Assembly Objekts enthalten keine vertraulichen Informationen.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-268">If you create an **ApplicationPart** object, make sure that the embedded resources associated with that **ApplicationPart** object's assembly do not contain sensitive information.</span></span>
...
> 
> - <span data-ttu-id="fd1b9-296">Auf Windows Vista oder Windows 7 aktiviert.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-296">On Windows Vista or Windows 7, enable UAC.</span></span>
...
> <span data-ttu-id="fd1b9-308">Die **Fremdschlüssel** Dialogfeld lässt nicht zu der Primärschlüsselname geben an der Primärschlüsseltabelle.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-308">The **Foreign Key** dialog box does not allow you to enter the primary key name from the primary key table.</span></span>
> 
...
> 
> <span data-ttu-id="fd1b9-322">**Workaround** </span><span class="sxs-lookup"><span data-stu-id="fd1b9-322">**Workaround** </span></span>  
...
> <span data-ttu-id="fd1b9-356">In einigen Fällen verursacht das Veröffentlichen einer Anwendung einen Fehler "Dienst ist nicht verfügbar" aus.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-356">Under some circumstances, publishing an application causes a "service is unavailable" error.</span></span>
> 
...
> <span data-ttu-id="fd1b9-395">Wenn Sie veröffentlichen oder eine DotNetNuke-Website herunterladen, müssen Sie zum Löschen des Caches, rufen Sie die neuen Links auf der Website angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-395">If you publish or download a DotNetNuke site, you might need to clear the cache to get the new links to appear on the site.</span></span>
> 
> <span data-ttu-id="fd1b9-396">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="fd1b9-396">**Workaround**</span></span>
> 
> 1. <span data-ttu-id="fd1b9-397">Melden Sie sich als "Host".</span><span class="sxs-lookup"><span data-stu-id="fd1b9-397">Log in as "Host".</span></span>
> 2. <span data-ttu-id="fd1b9-398">Wechseln Sie zum Hostmenü, und wählen Sie **Hosteinstellungen**.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-398">Go to the host menu and select **Host Settings**.</span></span>
> 3. <span data-ttu-id="fd1b9-399">Führen Sie einen Bildlauf nach unten, und klicken Sie unter **Erweiterte Einstellungen**, erweitern Sie **Leistungseinstellungen**.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-399">Scroll down and under **Advanced Settings**, expand **Performance Settings**.</span></span>
> 4. <span data-ttu-id="fd1b9-400">Klicken Sie auf die **Cache löschen** Link, um Seiten.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-400">Click the **Clear Cache** link for pages.</span></span>
> 5. <span data-ttu-id="fd1b9-401">Wechseln Sie zum unteren Rand der Seite, und starten Sie die Anwendung neu.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-401">Go to the bottom of the page and restart the application.</span></span>


#### <a name="issue-some-links-in-atomsite-are-broken-after-you-download-a-published-site"></a><span data-ttu-id="fd1b9-402">Problem: Einige Links in AtomSite werden unterbrochen, nachdem Sie eine veröffentlichte Website heruntergeladen haben.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-402">Issue: Some links in AtomSite are broken after you download a published site</span></span>

> <span data-ttu-id="fd1b9-403">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="fd1b9-403">**Workaround**</span></span>  
> <span data-ttu-id="fd1b9-404">In der *service.config* Datei *users.config* -Datei, und alle *XML* -Dateien, ersetzen Sie die URL-Zeichenfolge (z. B. `http://myhost.com/atomsite`) mit den lokalen Endpunkt (z. B. `http://localhost:1239`).</span><span class="sxs-lookup"><span data-stu-id="fd1b9-404">In the *service.config* file, *users.config* file, and all *.xml* files, replace the URL string (for example, `http://myhost.com/atomsite`) with the local one (for example, `http://localhost:1239`).</span></span>


#### <a name="issue-mysql-based-applications-like-wordpress-fail-to-publish-and-report-a-database-error"></a><span data-ttu-id="fd1b9-405">Problem: MySQL-basierte Anwendungen wie WordPress nicht veröffentlichen und einen Fehler gemeldet</span><span class="sxs-lookup"><span data-stu-id="fd1b9-405">Issue: MySQL-based applications like WordPress fail to publish and report a database error</span></span>

> <span data-ttu-id="fd1b9-406">WebMatrix installiert standardmäßig MySQL mit dem UTF-8-Zeichensatz.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-406">By default, WebMatrix installs MySQL with the UTF-8 character set.</span></span> <span data-ttu-id="fd1b9-407">Wenn Sie MySQL selbst installieren, und der Zeichensatz nicht UTF-8 (z. B. befindet er sich Latin1), der Veröffentlichungsprozess für Datenbanken fehlschlagen.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-407">If you install MySQL on your own, and the character set is not UTF-8 (for example, it is Latin1), the publish process for databases might fail.</span></span>
> 
> <span data-ttu-id="fd1b9-408">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="fd1b9-408">**Workaround**</span></span>
> 
> 1. <span data-ttu-id="fd1b9-409">Ändern Sie den Zeichensatz für MySQL in UTF-8.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-409">Change the character set for MySQL to UTF-8.</span></span> <span data-ttu-id="fd1b9-410">(Weitere Informationen finden Sie unter [Server Zeichensatz und Sortierreihenfolge](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html) auf der MySQL-Website.)</span><span class="sxs-lookup"><span data-stu-id="fd1b9-410">(For details, see [Server Character Set and Collation](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html) on the MySQL website.)</span></span>
> 2. <span data-ttu-id="fd1b9-411">Installieren Sie die Anwendung neu.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-411">Reinstall the application.</span></span>
> 3. <span data-ttu-id="fd1b9-412">Veröffentlichen Sie die Anwendung erneut.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-412">Republish the application.</span></span>


#### <a name="issue-download-published-site-fails-for-applications-that-have-browser-based-setup"></a><span data-ttu-id="fd1b9-413">Problem: "Download der veröffentlichten Website" für Anwendungen, Browser-basiertes Setup ein Fehler auftritt</span><span class="sxs-lookup"><span data-stu-id="fd1b9-413">Issue: "Download published site" fails for applications that have browser-based setup</span></span>

> <span data-ttu-id="fd1b9-414">Einige Anwendungen (z. B. Kentico CMS), müssen Sie sie im Browser zu starten, um nach der Installation von z. B. das Erstellen einer Datenbank auszuführen.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-414">Some applications (for example, Kentico CMS) require you to launch them in the browser in order to perform post-installation setup such as creating a database.</span></span> <span data-ttu-id="fd1b9-415">Wenn Sie eine Anwendung wie folgt, ohne das Browser-basierte Setup abschließen veröffentlichen, schlägt fehl, es wird versucht, die am selben Standort von einem Remoteserver herunterladen.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-415">If you publish an application like this without completing the browser-based setup, attempting to download the same site from a remote server will fail.</span></span>
> 
> <span data-ttu-id="fd1b9-416">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="fd1b9-416">**Workaround**</span></span>  
> <span data-ttu-id="fd1b9-417">Schließen Sie vor dem Veröffentlichen der Website-Browser-basiertes Setup.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-417">Finish browser-based setup before publishing the site.</span></span>


#### <a name="issue-download-published-site-fails-with-a-database-error-for-dotnetnuke-and-kooboo-cms"></a><span data-ttu-id="fd1b9-418">Problem: "Download der veröffentlichten Website" schlägt fehl mit eines Datenbankfehlers DotNetNuke und Kooboo-CMS</span><span class="sxs-lookup"><span data-stu-id="fd1b9-418">Issue: "Download published site" fails with a database error for DotNetNuke and Kooboo CMS</span></span>

> <span data-ttu-id="fd1b9-419">Wenn Sie versuchen, eine Anwendung von einem Server herunterzuladen, und Sie über Administratoranmeldeinformationen, in der Datenbank-Verbindungszeichenfolge in verfügen der **Veröffentlichungseinstellungen** Dialogfeld möglicherweise den folgenden Fehler im Protokoll veröffentlichen angezeigt:</span><span class="sxs-lookup"><span data-stu-id="fd1b9-419">If you try to download an application from a server and you have administrator credentials in the database connection string in the **Publish Settings** dialog, you might see the following error in the publish log:</span></span>
> 
> [!code-console[Main](overview/samples/sample9.cmd)]
> 
> <span data-ttu-id="fd1b9-420">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="fd1b9-420">**Workaround**</span></span>  
> <span data-ttu-id="fd1b9-421">Sollte möglichst die Website erneut zu veröffentlichen (oder dessen Veröffentlichung) mit nicht-Administrator-Anmeldeinformationen für die Datenbank.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-421">If practical, republish the site (or have it published) using non-administrator credentials for the database.</span></span>


<a id="More_Info"></a>

## <a name="for-more-information"></a><span data-ttu-id="fd1b9-422">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="fd1b9-422">For More Information</span></span>

<span data-ttu-id="fd1b9-423">Weitere Informationen zu WebMatrix 1.0 finden Sie unter den folgenden Websites:</span><span class="sxs-lookup"><span data-stu-id="fd1b9-423">For more information about WebMatrix 1.0, see the following websites:</span></span>

- [<span data-ttu-id="fd1b9-424">IIS.net</span><span class="sxs-lookup"><span data-stu-id="fd1b9-424">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="fd1b9-425">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="fd1b9-425">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="fd1b9-426">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="fd1b9-426">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

<span data-ttu-id="fd1b9-427">© 2011 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-427">© 2011 Microsoft Corporation.</span></span> <span data-ttu-id="fd1b9-428">Alle Rechte vorbehalten.</span><span class="sxs-lookup"><span data-stu-id="fd1b9-428">All Rights Reserved.</span></span> <span data-ttu-id="fd1b9-429">[Nutzungsbedingungen](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="fd1b9-429">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
