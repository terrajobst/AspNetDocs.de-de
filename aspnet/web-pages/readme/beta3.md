...
#### <a name="issue-webmatrix-beta-3-is-only-available-on-platforms-that-support-microsoft-net-framework-4"></a>Problem: WebMatrix Beta 3 kann nur auf Plattformen, die Unterstützung von Microsoft .NET Framework 4
...
#### <a name="new-htmlraw-method-renders-unencoded-markup"></a>New: Rendert nicht codierte Markup "von Html.Raw"-Methode
...
#### <a name="issue-encrypt-property-is-not-recognized"></a>Problem: Eigenschaft "Verschlüsseln" wird nicht erkannt.
